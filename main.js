...
async function connectionUpdate(update) {
 ...
 // if (update.receivedPendingNotifications) conn.sendMessage(`6282389924037@s.whatsapp.net`, {text: 'Berhasil tersambung dengan Dann-MD' }) Dann Official
}
